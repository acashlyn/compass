		...
		>
			<Animated.View
				style={[
					...
					{ transform: [{ translateY: topLogoAnimation }] },
				]}
			>
				<Image
			...
			<Animated.View
				style={[
					...
					{ transform: [{ translateY: lspuLogoAnimation }] },
				]}
			>
				<Image
			...
			<Animated.View
				style={[
					...
					{ transform: [{ translateY: welcomeTextAnimation }] },
				]}
			>
			...
			<Animated.View
				style={[styles.formContainer, { opacity: fadeInAnimation }]}
			>
				<TextInput
					style={styles.input}
			...
			>
				<View style={styles.modalContainer}>
					<View style={styles.modalContent}>
						...
						<TouchableOpacity
							style={styles.continueButton}
							onPress={handleContinueAfterSignUpSuccess}
						>
							<Text style={styles.buttonText}>CONTINUE</Text>
						</TouchableOpacity>
					</View>
				...
				<View style={styles.modalContainer}>
					<View style={styles.modalContentC}>
						<Image
							...
							style={styles.modalIcon}
						/>
						<Text style={styles.modalHeaderC}>
